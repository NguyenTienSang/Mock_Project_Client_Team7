...
import { UserListDeletedService } from './user-deleted.service';
...
export class UserListDeletedComponent implements OnInit {
   ...
   * Constructor
   *
   * @param {UserListDeletedService} _userListDeletedService
   * @param {CoreSidebarService} _coreSidebarService
   */
  constructor(private _userListDeletedService: UserListDeletedService,
